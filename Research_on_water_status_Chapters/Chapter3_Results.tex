...
\begin{tikzpicture}
	\begin{axis}[
			title={Temperature dependence of water flow at different ratios},
			xlabel={Temperature},
			ylabel={Water flow},
			xmin=50, xmax=75,
			ymin=2, ymax=5.5,
		...
		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.0:2.0}] {Research_on_water_status_data/airside_waterflow_120A.csv};
		\addlegendentry{Ratio 2.0}

		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.2:2.2}] {Research_on_water_status_data/airside_waterflow_120A.csv};
		\addlegendentry{Ratio 2.2}

		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.4:2.4}] {Research_on_water_status_data/airside_waterflow_120A.csv};
		\addlegendentry{Ratio 2.4}

		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.6:2.6}] {Research_on_water_status_data/airside_waterflow_120A.csv};
		\addlegendentry{Ratio 2.6}
		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.8:2.8}] {Research_on_water_status_data/airside_waterflow_120A.csv};
...
\begin{tikzpicture}
	\begin{axis}[
		...
		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{1.8:1.8}] {Research_on_water_status_data/airside_waterflow_210A.csv};
		\addlegendentry{Ratio 1.8}

		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.0:2.0}] {Research_on_water_status_data/airside_waterflow_210A.csv};
		\addlegendentry{Ratio 2.0}

		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.2:2.2}] {Research_on_water_status_data/airside_waterflow_210A.csv};
		\addlegendentry{Ratio 2.2}

		\addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.4:2.4}] {Research_on_water_status_data/airside_waterflow_210A.csv};
		\addlegendentry{Ratio 2.4}
...
% 	\subfigure[]{
% 		\label{fig:fig4a}
% 		\includegraphics[width=7cm, height=4.5cm]{Research_pictures/fig4a.png}
% 	}
% 	\subfigure[]{
% 		\label{fig:fig4b}
% 		\includegraphics[width=7cm, height=4.5cm]{Research_pictures/fig4b.png}
% 	}
% 	\subfigure[]{
% 		\label{fig:fig4c}
% 		\includegraphics[width=7cm, height=4.5cm]{Research_pictures/fig4c.png}
% 	}
