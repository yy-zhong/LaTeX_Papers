...
\begin{figure}[ht]
	\centering
	\subfloat[\label{fig:fig8a}]{\includegraphics[width=0.4\textwidth]{Research_pictures/fig8a.png}}
	\subfloat[\label{fig:fig8b}]{\includegraphics[width=0.4\textwidth]{Research_pictures/fig8b.png}}
	\\
	\subfloat[\label{fig:fig8c}]{\includegraphics[width=0.4\textwidth]{Research_pictures/fig8c.png}}
...
\begin{figure}[ht]
	...
	\subfloat[\label{fig:fig9a}]{
		\includegraphics[width=0.5\textwidth]{Research_pictures/fig9a.png}
	}
	\subfloat[\label{fig:fig9b}]{\includegraphics[width=0.5\textwidth]{Research_pictures/fig9b.png}}

	\subfloat[\label{fig:fig9c}]{\includegraphics[width=0.5\textwidth]{Research_pictures/fig9c.png}}
