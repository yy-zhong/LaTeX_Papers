...
\begin{tikzpicture}
    \begin{axis}[
        ...
        ylabel={Air Side Waterflow/ $g \cdot s^{-1}$},
        xmin=60, xmax=75,
        ymin=7, ymax=10,
    ...
    \addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{1.8:1.8}] {Research_on_water_status_data/airside_waterflow_300A.csv};
    \addlegendentry{Ratio 1.8}
    
    \addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.0:2.0}] {Research_on_water_status_data/airside_waterflow_300A.csv};
    \addlegendentry{Ratio 2.0}
    
    \addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.2:2.2}] {Research_on_water_status_data/airside_waterflow_300A.csv};
    \addlegendentry{Ratio 2.2}
    
    \addplot table [x=temperature, y=waterflow, col sep=comma, restrict expr to domain={\thisrow{ratio}}{2.4:2.4}] {Research_on_water_status_data/airside_waterflow_300A.csv};
