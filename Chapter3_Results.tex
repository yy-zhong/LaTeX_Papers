...
\end{itemize}
As shown in Fig \ref{fig:figure9}, 120A/67℃/2.15, 210A/68℃/2.15, 300A/70℃/2.05 are selected as the appropriate operating conditions under each load current.
\begin{figure}
	\label{fig:figure9}
	\subfigure[]{
		\label{fig:fig9a}
